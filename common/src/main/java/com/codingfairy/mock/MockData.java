...
public class MockData {
    ...
    private ProbeJson mockProbeJson(long time) {
        ...
        probeJson.setAddr("University of California, Irvine");
    ...
    private PhoneJson packagePhoneJson(PhoneJson phoneJson) {
        ...
        phoneJson.setEssid0("STARBUCKS");
        phoneJson.setEssid1("CHASE Bank");
        phoneJson.setEssid2("ALP");
        phoneJson.setEssid3("home");
        phoneJson.setEssid4("abcd");
        phoneJson.setEssid5("xiong");
        phoneJson.setEssid6("DBH");
        return phoneJson;
    }
